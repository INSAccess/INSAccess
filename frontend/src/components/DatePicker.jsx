...
export const CustomDatePicker = ({ isMobile = false }) => {
    ...
    return (
        <div className="position-relative d-inline-block">
            <button
                ref={buttonRef}
                className={`btn btn-primary ${isMobile ? 'btn-sm' : 'btn-lg'} d-flex align-items-center gap-2`}
                type="button"
            ...
            {showDatePicker && (
                <div className="position-absolute" style={{ top: '100%', left: '50%', transform: 'translateX(-50%)', zIndex: 1050, marginTop: '8px' }}>
