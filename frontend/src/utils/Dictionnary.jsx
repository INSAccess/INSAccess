  ...
  en: {
    translation: {
      ...
      manual: {
        ...
        chooseClassesContent:
          '1) Got to Settings / TD List \n2) Select your department and year (ex: ITI 4) \n3) Select your TD groups (if you are in doubt, or to simplify the task, look for the TD groups by clicking on the class on ' +
          LINK_AGENDA +
      ...
      faq: {
        ...
        assoPublisherAnswer:
          'If you are eligible (an association, a club, or an INSA Service for exemple) you can contact the DSI (via ' +
          LINK_SUPPORT +
  ...
  fr: {
    translation: {
      ...
      about: {
        title: 'Le projet',
        content:
          "Ce projet, initié par Raphaël Senellart et Jules Galhardo en ITI, vise à faciliter l'accès des étudiants aux cours et aux événements culturels de l'INSA. De nombreuses personnes ont contribué à son développement et nous tenons à les remercier : M. Bonnegent et M. Vasseur (DSI), Mme Baudesson et Mme Caldin (Service Culture), ainsi que M. Reynet (Service Communication) pour leur soutien. Merci également à Michel Vespier pour ses conseils techniques sur l'interface du site. Nous remercions enfin les étudiants, élus, associations et clubs de l'INSA pour leurs suggestions et idées qui ont enrichi le projet.",
      },
      ...
      manual: {
        ...
        chooseClassesContent:
          '1) Allez dans Paramètres / Liste des TDs \n2) Selectionnez votre département et année (ex: ITI 4) \n3) Selectionnez les groupes de TD qui vous appartient (si vous avez un doute, ou tout simplement pour vous facilitez la tache, regardez quel sont les groupes de TD pour chaque cours en cliquant dessus sur ' +
          LINK_AGENDA +
      ...
      faq: {
        ...
        assoPublisherQuestion:
          'Comment est-ce que je peux publier des événements ?',
        assoPublisherAnswer:
          'Si vous êtes éligible (une association, un club ou un service INSA par exemple), vous pouvez contacter le DSI (via ' +
          LINK_SUPPORT +
          ", catégorie 'Service en ligne > Emploi du temps') pour être référencé en tant qu'éditeur. Vous devez avoir préalablement visité le site web au moins une fois (pour que votre compte soit créé via CAS) et il doit y avoir une personne légalement responsable du compte CAS que vous utiliserez. Une fois toutes ces étapes effectuées, un onglet supplémentaire apparaîtra dans la page Paramètres pour vous permettre de créer et de publier un événement.",
