...
export { hoursTimeline, minWidth, nbDaysPerMonth, baseEventWidth, API_URL, PATH_ASSO, PATH_CALENDAR, API_LOGIN, API_LOGOUT, API_AUTH, departementNames, departementYears, LANGUAGES };